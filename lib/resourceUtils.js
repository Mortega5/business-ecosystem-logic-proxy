...
/**
 * Returns the resources linked to a spec that are not yet retired/obsolete, i.e. what would
 * block the spec from being retired. No data means no linked resources, so nothing blocks it.
 */
exports.getBlockingResources = function (data) {
    if (!data) {
        return [];
    }
